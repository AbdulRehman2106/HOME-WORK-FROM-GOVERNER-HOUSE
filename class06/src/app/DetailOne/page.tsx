    ...
    <div className="bg-blue-100 min-h-screen">
      ...
      <div className="flex flex-col items-center px-2 h-full w-full">
        ...
        <p className="text-center px-4 mt-11 mb-6 text-black font-sans font-bold text-[16px]">
          The Toyota Corolla 2024 Is A Compact, Stylish Car With A Modern And
          ...
          Efficient, And Packed With Features, The Corolla Is A Great Choice For
          Anyone Looking For A Compact And Well-Equipped Car.
        </p>
        <h2 className="text-green-700 text-center text-2xl font-bold">PKR 75.5 Lacs</h2>
