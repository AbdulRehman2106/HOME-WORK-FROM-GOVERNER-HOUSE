...
const Dynamicbook = async (props: any) => {
    ...
    return (
        ...
        <div className="font-extrabold italic bg-black min-h-screen">
            ...
            <h1 className="text-center text-4xl cursor-pointer underline hover:underline text-green-800 hover:text-green-500 py-10 md:py-14">Comments</h1>

            <ol className="text-2xl text-center bg-black pt-5  space-y-5">

                <li className="underline hover:underline border border-rose-600 text-red-700 hover:text-red-500 py-3 px-5 mx-5 ">Post ID: {response.postId}</li>
                ...
                <li className="underline hover:underline border border-emerald-500 text-emerald-700 hover:text-emerald-500 py-3 px-5 mx-5 ">Name: {response.name}</li>
