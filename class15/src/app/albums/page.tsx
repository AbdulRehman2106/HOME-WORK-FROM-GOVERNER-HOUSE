...
export default async function Home() {
  ...
  return (
    ...
    <div className="bg-black font-extrabold italic pb-24 min-h-screen">
      ...
      <h1 className="text-center text-4xl md:text-5xl cursor-pointer underline hover:underline text-amber-600 hover:text-yellow-500 mb-10 py-14">Albums</h1>
        ...
        {response.map((albums: any) => (
          ...
          <div key={albums.id} className="bg-black border border-lime-500 p-4 rounded-md">
            ...
            <Link href={`/albums/${albums.id}`}>
              ...
              <h1 className="text-lg md:text-xl font-extrabold italic hover:underline text-amber-800 hover:text-yellow-500">
