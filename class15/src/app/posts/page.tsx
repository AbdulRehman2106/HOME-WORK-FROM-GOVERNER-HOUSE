...
export default async function Home() {
  ...
  return (
    ...
    <div className="bg-black font-extrabold italic pb-24 min-h-screen">
      ...
      <h1 className="text-center text-4xl md:text-5xl cursor-pointer underline hover:underline text-sky-800 hover:text-blue-500 mb-10 py-14">Posts</h1>
        ...
        {response.map((posts: any) => (
          ...
          <div key={posts.id} className="bg-black border border-cyan-500 p-4 rounded-md">
            ...
            <Link href={`/posts/${posts.id}`}>
              ...
              <h1 className="text-lg md:text-xl font-extrabold italic hover:underline text-sky-800 hover:text-blue-500">
