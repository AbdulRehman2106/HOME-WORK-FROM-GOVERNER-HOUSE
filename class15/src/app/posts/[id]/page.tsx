...
const Dynamicbook = async (props: any) => {
    ...
    return (
        ...
        <div className="font-extrabold italic bg-black min-h-screen">
            ...
            <h1 className="text-center text-4xl md:text-5xl cursor-pointer underline hover:underline text-sky-800 hover:text-blue-500 py-10 md:py-14">Posts</h1>

            <ol className="text-2xl md:text-4xl text-center bg-black pt-5 md:pt-10 space-y-5">

                <li className="underline hover:underline border border-rose-600 text-red-700 hover:text-red-500 py-3 px-5 mx-5 md:mx-[20%] lg:mx-[30%]">User: {response.userId}</li>
